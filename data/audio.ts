...
export const AUDIO_SCHOLARS: ScholarBlock[] = [
  {
    ...
    episodes: [
      ...
      { icon: "▶️", badge: "يوتيوب", title: "الحجاب حجاب القلب", desc: "الحجاب الحقيقي يبدأ من القلب قبل الجسد — تأمل في المعنى الأعمق للستر والحياء.", url: "https://www.youtube.com/watch?v=dBIqOKJqZ5g", cta: "شاهد الآن ←" },
    ],
  },
  {
